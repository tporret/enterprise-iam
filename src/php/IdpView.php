	...
	public static function detail( array $idp, array $extra = array() ): array {
		return array_merge(
			array(
				...
				'saml_sp_certificate'        => sanitize_textarea_field( (string) ( $idp['saml_sp_certificate'] ?? '' ) ),
				'saml_sp_private_key'        => ! empty( $idp['saml_sp_private_key'] ) ? '••••••••' : '',
				'saml_authn_requests_signed' => ! empty( $idp['saml_authn_requests_signed'] ),
				'saml_want_assertions_encrypted' => ! empty( $idp['saml_want_assertions_encrypted'] ),
				'saml_want_nameid_encrypted' => ! empty( $idp['saml_want_nameid_encrypted'] ),
