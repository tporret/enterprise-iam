...
final class SecurityManager {
	...
	private function lockdown_rest_api(): void {
		add_filter( 'rest_authentication_errors', static function ( ?\WP_Error $result ): ?\WP_Error {
		...
		add_filter( 'rest_pre_dispatch', static function ( mixed $result, \WP_REST_Server $server, \WP_REST_Request $request ) {
	...
	private function restrict_application_passwords(): void {
		add_filter( 'wp_is_application_passwords_available_for_user', static function ( bool $available, \WP_User $user ): bool {
