...
$temp_dir    = sys_get_temp_dir() . '/enterprise-iam-bootstrap-' . getmypid();
...
if ( '' !== $bootstrap_output ) {
	fwrite( STDERR, "FAIL: Broken autoloader should not emit frontend output.\n" );
	exit( 1 );
}
...
fwrite( STDOUT, "PASS: Bootstrap handles an incomplete Composer vendor install without a fatal error.\n" );